...
# ====================== CONFIGURATION ======================
MODEL_DIR = os.path.expanduser("~/Desktop/微调+ONNX转换+量化/trained_model_tinybert") # 改为原始模型文件夹路径（1）
ONNX_MODEL_PATH = os.path.expanduser("~/Desktop/微调+ONNX转换+量化/trained_model_tinybert.onnx") # 改为量化前ONNX文件路径（2）
QUANT_MODEL_PATH = os.path.expanduser("~/Desktop/微调+ONNX转换+量化/trained_model_tinybert_quant.onnx") # 改为量化后ONNX文件路径（3）
DATASET_PATH = os.path.expanduser("~/Desktop/微调+ONNX转换+量化/dataset.csv") # 改为测试集路径（4）
