...
MODEL_DIR = os.path.expanduser("~/Desktop/微调+ONNX转换+量化/trained_model_tinybert") # 需要改路径（1）

# ONNX输出目录 (确保此目录已存在)
ONNX_OUTPUT_DIR = os.path.expanduser("~/Desktop/微调+ONNX转换+量化") # 需要改路径（2）

# ONNX文件名 (不需要带路径)
ONNX_FILENAME = "trained_model_tinybert.onnx" # 需要改路径（3）
