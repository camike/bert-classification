...
# ====================== CONFIGURATION ======================
MODEL_DIR = os.path.expanduser("~/Desktop/quantization/tinybert_training_results/checkpoint-1640") # tinybert_training_results/checkpoint-1640
ONNX_MODEL_PATH = os.path.expanduser("~/Desktop/quantization/tinybert_model.onnx")
QUANT_MODEL_PATH = os.path.expanduser("~/Desktop/quantization/tinybert_model_quant.onnx")
DATASET_PATH = os.path.expanduser("~/Desktop/quantization/dataset.csv")

MAX_LENGTH = 512  # Should match what you used during training
# ===========================================================
